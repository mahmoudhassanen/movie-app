...
export default function Movie() {
  ...
  async function GetTrendingItems(mediaType , callback) {
    let {data} = await axios.get('https://api.themoviedb.org/3/trending/movie/day?api_key=962235938e93a7ebd52595b7579413dd')
    ...
    <div className='container'>
      <div className='row mt-5'>
        ...
        <div className='col-md-4   d-flex align-items-center' >
          ...
          <h2> Movie</h2>
          <h2> To Watch Now</h2>
          <p className='second mt-4 mb-4'> Most watched movie by week.</p>
